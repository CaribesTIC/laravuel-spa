...
// @ts-nocheck
import useIndex from "../../composables/Meeting/useIndex";
...
<template>
<div>
  <AppPageHeader> Meetings </AppPageHeader>

  <div class="flex space-x-2">
    <AppLink class="btn btn-primary" to="/meetings/create">
      <span>Crear</span>
    </AppLink>
  </div>
      ...
      <table class="table-data">
        <thead>
          <tr class="">
              ...
              <th class="">
                <AppLink to="#" @click.prevent="setSort('reason')">reason</AppLink>
              </th>
              <th class="">
        ...
        <tbody>
          <tr v-for="row in data.rows" :key="row.id" class="">
             <td class="">
              <AppLink
                ...
                :to="{ name: 'meetingEdit', params: { id: row.id }}"
              >
                {{ row.id }}
              </AppLink>
            </td>
            ...
            <td class="">
              <div class="flex items-center space-x-1">                
                <AppBtn
                  ...
                  @click="router.push({ path: '/meetings/edit/'+row.id })"
                >
                  Editar
                </AppBtn>
                <AppBtn
          ...
          <tr v-if="data.rows.length === 0">
            <td class="" colspan="4">Meetings not found.</td>
          </tr>
        </tbody>
      </table>
    </div>
