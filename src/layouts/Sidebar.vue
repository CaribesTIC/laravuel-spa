<template>
  <div class="flex">
    ...
    <div
      ...
      class="fixed z-30 inset-y-0 left-0 w-64 transition duration-300 transform bg-gray-600 overflow-y-auto lg:translate-x-0 lg:static lg:inset-0"
    >
      ...
      <nav class="mt-3">
        ...
        <router-link
          class="flex items-center duration-200 mt-4 py-2 px-6 border-l-4"
          :class="[($route.name === 'xsers' || $route.name === 'xserShow' || $route.name === 'xserEdit') ? activeClass : inactiveClass]"
          to="/xsers"
        >
          <svg
            class="h-5 w-5"
